...
@push('banner_title','About Us')

@section('content')

    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light mb-5 mt-5">
        <div class="container">
            <div class="row">
                <div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url('{{ asset('images/about.jpg') }}')">
                    <a href="https://www.youtube.com/watch?v=N1-Jmq7BLFE" class="icon popup-vimeo d-flex justify-content-center align-items-center">
